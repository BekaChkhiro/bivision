...
function bevision_render_products_cpt_block($attributes, $content) {
    ...
    $output .= '<h3 class="products-section-subtitle" style="color: var(--Dark-Blue, #221A4C); text-align: center; font-size: 30px; font-style: normal; font-weight: 700; line-height: normal; margin: 0px 0px 60px;">' . esc_html($section_subtitle) . '</h3>';
    ...
    foreach ($products as $product) {
        ...
        if ($product['id'] !== 'default-product') {
            ...
            if (!empty($product['link'])) {
                $output .= '<a href="' . esc_url($product['link']) . '" class="products-button products-button-primary" style="background-color: #6653C6; color: #fff; padding: 0px 40px; font-size: 16px; font-style: normal; font-weight: 400; line-height: normal; border: none; border-radius: 8px; cursor: pointer; transition: all 0.3s ease; text-decoration: none; display: flex; align-items: center; justify-content: center; height: 50px;">' . esc_html($primary_button_text) . '</a>';
            }
            
            // Book a Call button (opens popup)
            $output .= '<button class="products-button products-button-secondary open-lead-popup" style="background-color: #2FCA02; color: #fff; padding: 0px 40px; font-size: 16px; font-style: normal; font-weight: 700; line-height: normal; border: none; border-radius: 8px; cursor: pointer; transition: all 0.3s ease; display: flex; align-items: center; justify-content: center; height: 50px;">' . esc_html($secondary_button_text) . '</button>';
