...
function bevision_menu_shortcode($atts) {
    ...
    class Bevision_Menu_Walker extends Walker_Nav_Menu {
        ...
        function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
            ...
            // Add different class based on depth
            if ($depth === 0) {
                $atts['class'] = 'menu-item-title';
            } else {
                $atts['class'] = 'submenu-item-title';
            }
...
function bevision_menu_styles() {
    ...
    <style>
        ...
        .bevision-menu-items .sub-menu a.submenu-item-title {
            text-align: left;
            font-size: 16px;
            font-weight: 700;
            color: #221A4C;
        ...
        .bevision-menu-items .sub-menu a.submenu-item-title:hover {
            color: #6c5ce7;
        }
