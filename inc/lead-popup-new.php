        ...
        <div class="new-popup-content">
            ...
            <div id="demo-form-wrapper">
                ...
                <div id="success-part" style="display: none; text-align: center; position: relative;">
                    <button class="new-popup-close" style="position: absolute; top: -45px; right: -10px; font-size: 30px; background: none; border: none; cursor: pointer; color: #888; width: 30px; height: 30px; line-height: 30px; text-align: center; transition: all 0.3s ease; z-index: 10;" onclick="document.getElementById('bevision-new-popup').style.display='none'; document.getElementById('new-popup-overlay').style.display='none';">&times;</button>
                    ...
                    <h3 style="color: var(--Dark-Blue, #221A4C); font-family: 'Helvetica Neue LT GEO'; font-size: 20px; font-style: normal; font-weight: 700; line-height: normal; margin-bottom: 10px;">თქვენი მოთხოვნა გაგზავნილია</h3>
                    <p style="color: var(--Grey, #8399AF); text-align: center; font-family: 'Helvetica Neue LT GEO'; font-size: 16px; font-style: normal; font-weight: 400; line-height: normal; margin-bottom: 30px;">მალე დაგიკავშირდებით</p>
