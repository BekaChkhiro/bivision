    ...
    <div class="new-popup-content">
        ...
        <div id="demo-form-wrapper">
            ...
            <div id="success-part" style="display: none; text-align: center; position: relative;">
                ...
                <button type="button" style="background-color: transparent; border: none; color: #6e7c90; font-size: 16px; padding: 10px 30px; cursor: pointer; font-family: system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif;">დახურვა</button>
            </div>
        </div>
    </div>
</div>
